...
<body>
    ...
    <nav class="navbar navbar-dark bg-primary">
        <div class="container">
            ...
            <div class="d-flex align-items-center">
                <a href="https://github.com/C018/cf-vps-monitor" target="_blank" rel="noopener noreferrer" class="btn btn-outline-light btn-sm me-2" title="GitHub Repository">
    ...
    <footer class="footer fixed-bottom py-2 bg-light border-top">
        <div class="container text-center">
            ...
            <a href="https://github.com/C018/cf-vps-monitor" target="_blank" rel="noopener noreferrer" class="ms-3 text-muted" title="GitHub Repository">
                <i class="bi bi-github"></i>
            </a>
        </div>
    </footer>
    ...
    <nav class="navbar navbar-dark bg-primary">
        <div class="container">
            ...
            <div class="d-flex align-items-center flex-wrap">
                ...
                <!-- PC端直接显示的按钮 -->
                <a href="https://github.com/C018/cf-vps-monitor" target="_blank" rel="noopener noreferrer" class="btn btn-outline-light btn-sm me-2 desktop-only" title="GitHub Repository">
                    <i class="bi bi-github"></i>
                </a>
                ...
                <div class="dropdown me-1 mobile-only">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="adminMenuDropdown">
                        <li><a class="dropdown-item" href="https://github.com/C018/cf-vps-monitor" target="_blank" rel="noopener noreferrer">
...
function getMainJs() {
  return extractMultiline(() => {/*__INLINE__START__// main.js - 首页面的JavaScript逻辑
...
async function loadSiteUptimeData() {
    ...
    try {
        ...
        uptimeData = data.sites || [];
        usedAdminApi = true;
    } catch (error) {
        console.warn('管理员网站在线率接口不可用，尝试公共接口：', error);
        const uptimeCells = document.querySelectorAll('td.uptime-cell[data-site-id]');
        const fallbackPromises = Array.from(uptimeCells || []).map(async cell => {
        ...
        uptimeData = (await Promise.all(fallbackPromises)).filter(Boolean);
    }

    if (!uptimeData.length) {
        if (!usedAdminApi) {
            console.error('加载网站在线率数据失败：无可用数据');
        }
...
function getLoginJs() {
  return extractMultiline(() => {/*__INLINE__START__// login.js - 登录页面的JavaScript逻辑
...
function getAdminJs() {
  return extractMultiline(() => {/*__INLINE__START__// admin.js - 管理后台的JavaScript逻辑
...
async function copyVpsInstallScript(serverId, serverName, buttonElement) {
    ...
    try {
        ...
        // 使用GitHub上的脚本地址
        const baseScriptUrl = "https://raw.githubusercontent.com/C018/cf-vps-monitor/main/cf-vps-monitor.sh";
